  ...
  return (
    <section className="hero">
      <div>
        ...
        <h1>Ask a question.<br />See the vote live.</h1>
        <p>
        ...
        <div className="hero-actions">
          ...
          <button className="secondary" onClick={() => navigate(user ? "/dashboard" : "/login")}>
            {user ? "View my polls" : "Log in"}
          </button>
        </div>
      </div>
      <div className="hero-card">
        <div className="live-dot"><span /> Live results</div>
        <div className="fake-question">Which feature should we build next?</div>
        <div className="fake-row"><span>Dark mode</span><b style={{width:"72%"}} /></div>
        <div className="fake-row"><span>Poll analytics</span><b style={{width:"52%"}} /></div>
        <div className="fake-row"><span>Team sharing</span><b style={{width:"35%"}} /></div>
